                            ...
                            <div class="grid grid-cols-8 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="name" id="first_name" autocomplete="given-name"
                                        ...
                                        value="{{ old('name') }}" placeholder="Ex: Gabriel">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="last_name" id="last_name" autocomplete="family-name"
                                        class="mt-1 block w-full rounded-md border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm  px-2"
                                        value="{{ old('last_name') }}" placeholder="Ex: Tavares">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input type="text" name="phone" id="phone" autocomplete="family-name"
                                        class="mt-1 block w-full rounded-md border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm  px-2"
                                        value="{{ old('phone') }}" placeholder="(XX) XXXX-XXXX">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="email" name="email" id="email" autocomplete="email"
                                        class="mt-1 block w-full rounded-md border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-2"
                                        value="{{ old('email') }}" placeholder="seunome@email.com">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="about" name="comments" rows="3"
                                        class="mt-1 block p-4 w-full rounded-md border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-2">{{ old('comments') }}</textarea>
                                </div>
                            </div>
                            <div>
